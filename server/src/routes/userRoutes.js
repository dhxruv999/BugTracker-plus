...
router.get('/alerts-count', authorizeRoles('org_admin', 'project_admin'), getAlertsCount)
...
router.put('/:id/reject-password-reset', authorizeRoles('org_admin', 'project_admin'), rejectPasswordReset)
...
router.put('/:id/reject', authorizeRoles('org_admin', 'project_admin'), rejectUser)
